-- Atualizar função RPC para permitir que líderes e admins vejam todos os grupos
...
BEGIN
    ...
    WHERE 
        -- Admins e líderes veem todos os grupos
        user_role IN ('admin', 'lider')
        -- Voluntários veem apenas grupos que criaram ou são membros
        OR (
            user_role = 'volunteer'
            AND (
