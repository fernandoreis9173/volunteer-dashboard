                ...
                <div className="flex items-center gap-1 sm:gap-2">
                    ...
                    <div className="relative" ref={viewDropdownRef}>
                        ...
                        >
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-500" fill="none" viewBox="0 0 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" /></svg>
                        </button>
                        {isViewDropdownOpen && (
