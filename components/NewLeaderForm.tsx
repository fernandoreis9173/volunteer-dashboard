...
interface NewLeaderFormProps {
    ...
    onCancel: () => void;
    onSave: (leader: Omit<Leader, 'created_at'>) => void;
    isSaving: boolean;
...
const NewLeaderForm: React.FC<NewLeaderFormProps> = ({ initialData, onCancel, onSave, isSaving, saveError }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const leaderData: Omit<Leader, 'created_at'> = {
            id: initialData?.id,
    ...
    return (
        <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-slate-200">
            ...
            <div className="flex items-center space-x-3 mb-8">
                ...
                <h2 className="text-2xl font-bold text-slate-800">{isEditing ? 'Editar Líder' : 'Novo Líder'}</h2>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <CheckboxField label="Líder ativo" name="ativo" checked={isActive} onChange={(e) => setIsActive(e.target.checked)} />
                ...
                <div className="pt-6 border-t border-slate-200 flex flex-wrap justify-end items-center gap-3">
                    ...
                    >
                        ...
                        <span>{isSaving ? 'Salvando...' : (isEditing ? 'Atualizar Líder' : 'Salvar Líder')}</span>
                    </button>
                </div>
            </form>
        </div>
