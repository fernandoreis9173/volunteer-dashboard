    ...
    <>
      ...
      >
        ...
        >
          ...
          {(event.cronograma_principal_id || event.cronograma_kids_id) && (
            <div className="mt-4">
              <button onClick={() => setIsTimelineViewerOpen(true)} className="w-full text-center px-4 py-2 text-sm font-semibold text-white bg-gray-700 rounded-lg hover:bg-gray-800 transition-colors">
                  Ver Cronograma
              </button>
            </div>
          )}
