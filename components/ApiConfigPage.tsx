            ...
            <div className="w-full max-w-lg p-8 space-y-6 bg-white rounded-2xl shadow-lg text-center">
                <div className="flex justify-center mb-4">
                  <div className="p-3 bg-red-500 text-white rounded-xl">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <div className="mt-2 text-slate-500 bg-slate-100 p-4 rounded-lg text-left text-sm">
                    <p>Para que o aplicativo funcione, você precisa configurar as seguintes variáveis de ambiente no seu ambiente de hospedagem:</p>
                    ...
                    <p className="mt-4">Após configurar as variáveis, por favor, faça o deploy novamente ou reinicie seu servidor de desenvolvimento.</p>
                </div>
            </div>
        </div>
    );
