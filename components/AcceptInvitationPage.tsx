...
export const AcceptInvitationPage: React.FC<AcceptInvitationPageProps> = ({ setAuthView, onRegistrationComplete }) => {
    ...
    return (
        <div className="min-h-screen w-full flex bg-white font-sans">{/* Removed overflow-hidden to allow scroll */}
            {/* Left Side - Form */}
            <div className="w-full lg:w-1/2 flex flex-col items-center px-6 pt-8 pb-8 lg:p-12 bg-white relative z-10 h-screen overflow-y-auto">
                <div className="w-full max-w-md space-y-5 pb-8">{/* Added pb-8 for bottom spacing */}
                    {/* Header */}
