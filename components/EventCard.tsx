            ...
            <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-4">
                <div>
                    ...
                    <div className="flex items-center space-x-4 text-sm text-slate-500 mt-1">
                        ...
                        <span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 inline -mt-1 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>{event.start_time} - {event.end_time}</span>
                    </div>
                </div>
                 <div className="flex items-center gap-2 self-start sm:self-center flex-shrink-0">
                    {isLeader && canLeaderSchedule && !isDepartmentInvolved && (
                        <button onClick={() => onAddDepartment(event)} className="px-3 py-1.5 bg-indigo-500 text-white text-sm font-semibold rounded-lg hover:bg-indigo-600 shadow-sm">
