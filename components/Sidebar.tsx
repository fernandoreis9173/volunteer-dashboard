...
const Sidebar: React.FC<SidebarProps> = ({ activePage, onNavigate, supabase, isOpen, setIsOpen }) => {
      ...
      <aside className={`fixed lg:static inset-y-0 left-0 w-64 bg-white flex flex-col p-6 border-r border-slate-200 z-30 transition-transform duration-300 ease-in-out transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}>
        ...
        <nav className="flex-1 flex flex-col space-y-4">
          ...
          <div>
            ...
            <div className="space-y-1">
               <button className="flex items-center space-x-3 px-4 py-2 rounded-lg transition-colors w-full text-left text-slate-600 hover:bg-slate-100 hover:text-slate-900">
        ...
        <div className="mt-auto">
          ...
          <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                  <div className="h-10 w-10 flex items-center justify-center bg-blue-100 rounded-full text-blue-500">
